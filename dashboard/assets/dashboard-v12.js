// dashboard-v11.js — v12 (Aggressive Timeouts) dashboard logic.
// Loads dashboard/data/v12-only.json (produced by scripts/v11-extract-data.py)
...
async function load() {
  let data;
  try {
    const resp = await fetch('data/v12-only.json', { cache: 'no-store' });
