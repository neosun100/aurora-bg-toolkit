...
Walks e2e-results/v16-* directories (each = one matrix run × scenario × round
...
Output: dashboard/data/v16-matrix.json
"""
...
OUT_FILE = REPO_ROOT / "dashboard/data/v16-matrix.json"
...
def main():
    ...
    # All v16-* run dirs
    pattern = "v16-*-*"  # e.g. v16-M3-r7g4xl-tps1280-blue-green-test-v11-3-r1_2026...
    for round_dir in sorted(RESULTS_DIR.glob(pattern)):
        ...
        # all runs. Reconstruct real workload TPS from "config" (e.g. "v16-tps4000"
